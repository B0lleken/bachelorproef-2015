...
/* 
	...
	techpost	: null, 	//add your user name
...
(function($) {
	...
	$.fn.jsocial = function(options) {
		...
		return this.each(function() {
			...
			if ( options.newPage ) {
				var target = 'target="_self"';		//if user wants link to open in new page
			};
...
if( options.twitter ) {list += '<li><a title="Volg ons op Twitter" href="' + options.twitter + '" class="twitter" ' + target + ' >Twitter</a></li>'; total_links ++;};

if( options.facebook ) {list += '<li><a title="Volg ons op Facebook" href="' + options.facebook + '" class="facebook" ' + target + ' >Facebook</a></li>'; total_links ++;};

if( options.techpost ) {list += '<li><a title="Onze eigen Techpost community" href="' + options.techpost + '" class="techpost" ' + target + ' >techpost</a></li>'; total_links ++;};
...
if( options.linked ) {list += '<li><a title="Volg ons op LinkedIn" href="' + options.linked + '" class="linked-in" ' + target + ' >Linked-In</a></li>'; total_links ++;};

if( options.youtube ) {list += '<li><a href="http://' + options.youtube + '" class="youtube" ' + target + ' >YouTube</a></li>'; total_links ++;};

if( options.feed ) {list += '<li><a title="Volg ons via de RSS-feed" href="' + options.feed + '" class="feed" ' + target + ' >Feedburner</a></li>'; total_links ++;};
